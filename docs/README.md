# OpenManifest Developer Documentation

| Document | Purpose |
| --- | --- |
| [Architecture](architecture.md) | Engine boundaries and plan/apply data flow |
| [YAML reference](yaml-reference.md) | Complete `openmanifest/app/v1alpha1` authoring contract |
...
provider example through `openmanifest validate` and `openmanifest plan --provider-requests`,

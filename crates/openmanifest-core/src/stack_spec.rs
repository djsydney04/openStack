...
pub const STACK_SPEC_VERSION: &str = "openmanifest/app/v1alpha1";
pub const LEGACY_STACK_SPEC_VERSION: &str = "stackport/app/v1alpha1";
...
pub fn validate_stack_spec(
    ...
    if spec.version != STACK_SPEC_VERSION && spec.version != LEGACY_STACK_SPEC_VERSION {
        return Err(format!(
...
pub fn validate_app_manifest(
    ...
    validate_stack_spec(manifest, target)
}
...
pub fn compile_app_manifest(
    ...
    stack_spec_to_manifest(manifest, target)
}
